...
class BedrockAgent:
    ...
    def __init__(self, environment_name) -> None:
        ...
        self.agent_id = (
            ...
            .client("ssm")
            .get_parameter(
                Name=f"/streamlitapp/{environment_name}/AGENT_ID", WithDecryption=True
            )["Parameter"]["Value"]
        )
        self.agent_alias_id = (
            Session()
            .client("ssm")
            .get_parameter(
                Name=f"/streamlitapp/{environment_name}/AGENT_ALIAS_ID",
                WithDecryption=True,
            )["Parameter"]["Value"]
        )
        ...
        self.s3_bucket_name = (
            ...
            .client("ssm")
            .get_parameter(
                Name=f"/streamlitapp/{environment_name}/S3_BUCKET_NAME",
                WithDecryption=True,
            )["Parameter"]["Value"]
        )
